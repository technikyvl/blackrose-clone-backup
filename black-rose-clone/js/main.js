...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const galleryImages = [
    // Manicure
    { id: 1,  src: 'portfolio/manicure/manicure-rozowy-ombre-french.webp',       alt: 'Manicure różowy ombre french',            category: 'Manicure' },
    { id: 2,  src: 'portfolio/manicure/manicure-nude-blyski.webp',               alt: 'Manicure nude z błyskami',                category: 'Manicure' },
    { id: 3,  src: 'portfolio/manicure/manicure-czerwony-nude.webp',             alt: 'Manicure czerwony nude',                  category: 'Manicure' },
    { id: 4,  src: 'portfolio/manicure/manicure-rozowy-perla.webp',              alt: 'Manicure różowy perła',                   category: 'Manicure' },
    { id: 5,  src: 'portfolio/manicure/manicure-lawendowy-bialy.webp',           alt: 'Manicure lawendowy biały',                category: 'Manicure' },
    { id: 6,  src: 'portfolio/manicure/manicure-slubny-bialy-burgund.webp',      alt: 'Manicure ślubny biały burgund',           category: 'Manicure' },
    { id: 7,  src: 'portfolio/manicure/manicure-rozowy-fiolet-perla.webp',       alt: 'Manicure różowy fiolet perła',            category: 'Manicure' },
    { id: 8,  src: 'portfolio/manicure/manicure-czerwony-perla-polysk.webp',     alt: 'Manicure czerwony perła połysk',          category: 'Manicure' },
    { id: 9,  src: 'portfolio/manicure/manicure-aplikacja-paznokcie.webp',       alt: 'Aplikacja lakieru na paznokcie',          category: 'Manicure' },
    { id: 10, src: 'portfolio/manicure/kolory-paznokci-wzornik.webp',            alt: 'Wzornik kolorów paznokci',                category: 'Manicure' },
    // Zdobienia
    { id: 11, src: 'portfolio/manicure/manicure-zolty-nail-art.webp',            alt: 'Nail art żółty z czarnymi wzorami',       category: 'Zdobienia' },
    { id: 12, src: 'portfolio/manicure/manicure-burgund-zlote-liscie.webp',      alt: 'Nail art burgund złote liście',           category: 'Zdobienia' },
    { id: 13, src: 'portfolio/manicure/manicure-bronz-geometria.webp',           alt: 'Nail art brąz geometria',                 category: 'Zdobienia' },
    { id: 14, src: 'portfolio/manicure/manicure-neon-zielony-kwiaty.webp',       alt: 'Nail art neon zielony kwiaty',            category: 'Zdobienia' },
    { id: 15, src: 'portfolio/manicure/manicure-bialy-kwiatowy.webp',            alt: 'Nail art biały wzór kwiatowy',            category: 'Zdobienia' },
    { id: 16, src: 'portfolio/manicure/manicure-neon-rozowy-ombre.webp',         alt: 'Nail art neon różowy ombre',              category: 'Zdobienia' },
    ...
    { id: 20, src: 'portfolio/zabiegi-na-twarz/zabieg-twarzy-urzadzenie.webp',               alt: 'Zabieg twarzy urządzeniem kosmetycznym', category: 'Zabiegi' },
    { id: 21, src: 'portfolio/zabiegi-na-twarz/zabieg-twarzy-pielegnacja.webp',              alt: 'Pielęgnacja twarzy - zabieg',            category: 'Zabiegi' },
    ...
    { id: 23, src: 'portfolio/zabiegi-na-twarz/analiza-skory-diagnostyka.webp',              alt: 'Analiza skóry urządzeniem diagnostycznym', category: 'Zabiegi' },
    { id: 24, src: 'portfolio/zabiegi-na-twarz/diagnostyka-skory-ekran.webp',                alt: 'Diagnostyka skóry - ekran analizy',       category: 'Zabiegi' },
    { id: 25, src: 'portfolio/koloryzacja-wlosow/koloryzacja-wlosow-technika-grzebieniowa.webp', alt: 'Koloryzacja włosów techniką grzebieniową', category: 'Zabiegi' },
    { id: 26, src: 'portfolio/koloryzacja-wlosow/koloryzacja-wlosow-farbowanie.webp',        alt: 'Farbowanie włosów',                      category: 'Zabiegi' },
    { id: 27, src: 'portfolio/koloryzacja-wlosow/koloryzacja-wlosow-ciemne-wlosy.webp',      alt: 'Koloryzacja ciemnych włosów',            category: 'Zabiegi' },
    { id: 28, src: 'portfolio/koloryzacja-wlosow/koloryzacja-wlosow-efekt-klientka.webp',    alt: 'Efekt koloryzacji włosów',               category: 'Zabiegi' },
    { id: 29, src: 'portfolio/salon/salon-lozko-drenaz-limfatyczny.webp',                    alt: 'Drenaż limfatyczny - zabieg modelowania', category: 'Zabiegi' },
    { id: 30, src: 'portfolio/salon/salon-drenaz-limfatyczny-nogi.webp',                     alt: 'Drenaż limfatyczny nóg',                 category: 'Zabiegi' },
    { id: 31, src: 'portfolio/salon/masaz-pracownik-podczas-zabiegu.webp',                   alt: 'Pracownica podczas zabiegu masażu',       category: 'Zabiegi' },
    // Salon
    { id: 32, src: 'portfolio/salon/salon-pudelko-roze-prezentacja.webp',        alt: 'Pudełko z różami Black Rose',             category: 'Salon' },
    ...
    { id: 35, src: 'portfolio/salon/salon-pudelko-black-rose.webp',              alt: 'Pudełko prezentowe Black Rose',           category: 'Salon' },
    { id: 36, src: 'portfolio/salon/salon-produkty-w-pudelku.webp',              alt: 'Produkty kosmetyczne w pudełku',          category: 'Salon' },
    { id: 37, src: 'portfolio/salon/salon-zestaw-prezentowy-overhead.webp',      alt: 'Zestaw prezentowy z góry',               category: 'Salon' },
    { id: 38, src: 'portfolio/salon/salon-zespol-pracownicy.webp',               alt: 'Zespół Black Rose Salon',                category: 'Salon' },
    { id: 39, src: 'portfolio/salon/salon-pracownik-portret.webp',               alt: 'Pracownica salonu - portret',             category: 'Salon' },
    { id: 40, src: 'portfolio/salon/salon-wyposazenie-magenta.webp',             alt: 'Wyposażenie salonu magenta',             category: 'Salon' },
    { id: 41, src: 'portfolio/salon/salon-modelka-biale-kwiaty.webp',            alt: 'Modelka z białymi kwiatami',             category: 'Salon' },
    { id: 42, src: 'portfolio/salon/salon-wzornik-kolorow-paznokci.webp',        alt: 'Wzornik kolorów paznokci Black Rose',    category: 'Salon' },
    { id: 43, src: 'portfolio/salon/salon-pracownik-bezowy-stroj.webp',          alt: 'Pracownica w beżowym stroju',            category: 'Salon' },
    { id: 44, src: 'portfolio/salon/salon-pokoj-zabiegowy-rozowe-swiatlo.webp',  alt: 'Pokój zabiegowy różowe światło',         category: 'Salon' },
    { id: 45, src: 'portfolio/salon/salon-pokoj-zabiegowy-pink.webp',            alt: 'Pokój zabiegowy Pink',                   category: 'Salon' },
  ];
